...
#else
	const ivec3 workGroups = ivec3(16, 8, 16); // Default fallback for disabled colored lighting
#endif
...
// Fallback compute shader when colored lighting is disabled
layout (local_size_x = 1, local_size_y = 1, local_size_z = 1) in;

void main() {
	// Empty compute shader - do nothing when colored lighting is disabled
}

...
// Variables are now defined earlier in Common Variables section
...
//Common Variables//
// Variables are now defined in common.glsl
#ifdef VERTEX_SHADER
    float SdotU, sunFactor, sunVisibility, sunVisibility2;
    // rainFactor2, noonFactor, invNoonFactor, invNoonFactor2 are in common.glsl
#endif
...
void main() {
    ...
    // Calculate variables after vectors are set
    SdotU = getSdotU(sunVec, upVec);
    sunFactor = getSunFactor(sunVec, upVec);
    sunVisibility = getSunVisibility(sunVec, upVec);
    sunVisibility2 = getSunVisibility2(sunVec, upVec);
    // rainFactor2, noonFactor, invNoonFactor, invNoonFactor2 are calculated in common.glsl
